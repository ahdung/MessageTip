...
#if UNSAFE
    static unsafe void BoxBlur(BitmapData data, int radius, Color color)
#else
    static void BoxBlur(BitmapData data, int radius, Color color)
#endif
    {
#if UNSAFE
